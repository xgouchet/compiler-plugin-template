...
object CompilationDiagnosticErrors : BaseDiagnosticRendererFactory() {

    val CHECK_CALL by error0<KtExpression>()
    val CHECK_NOT_NULL_CALL by error0<KtExpression>()

    val REQUIRE_CALL by error0<KtExpression>()
    val REQUIRE_NOT_NULL_CALL by error0<KtExpression>()
